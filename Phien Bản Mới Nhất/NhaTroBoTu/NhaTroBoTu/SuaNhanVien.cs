...
namespace NhaTroBoTu
{
    public partial class SuaNhanVien : Form
    {
        ...
        private void dataSuaNhanVien_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dataSuaNhanVien.Text = dataSuaNhanVien.Rows[i].Cells[4].Value.ToString();
            ...
            txtSuaLuong.Text = dataSuaNhanVien.Rows[i].Cells[7].Value.ToString();
        }
        ...
        private void btnOkSuaNV_Click(object sender, EventArgs e)
        {
            //try
            //{
                if (txtSuaMa.Text == "" || txtSuaTen.Text == "" || txtSuaSDT.Text == "" || txSuaDiaChi.Text == "" || txtSuaLuong.Text == "")
        ...
        private void dataSuaNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            int i;
            i = dataSuaNhanVien.CurrentRow.Index;
            txtSuaMa.Text = dataSuaNhanVien.Rows[i].Cells[0].Value.ToString();
